#!/usr/bin/env bash
# Provide-ego step100k: H15 plans, execute B=5 per replan, H80/K32/512 scenes.
...
COMMITMENT_STEPS=5
RUN_NAME="${RUN_NAME:-waymo_direct_action_flow_provideego_step100k_ctx11_h80_b5_k32_val128_cpd}"
SESSION_NAME="${SESSION_NAME:-wm_daf_provideego_step100k_h80_b5_k32_cpd}"
