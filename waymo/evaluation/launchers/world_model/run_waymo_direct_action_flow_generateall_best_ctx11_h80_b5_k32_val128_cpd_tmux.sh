#!/usr/bin/env bash
# Generate-all best.pt: H15 plans, execute B=5 per replan, H80/K32/512 scenes.
...
COMMITMENT_STEPS=5
RUN_NAME="${RUN_NAME:-waymo_direct_action_flow_generateall_best_ctx11_h80_b5_k32_val128_cpd}"
SESSION_NAME="${SESSION_NAME:-wm_daf_generateall_best_h80_b5_k32_cpd}"
