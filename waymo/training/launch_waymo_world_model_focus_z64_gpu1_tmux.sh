#!/usr/bin/env bash
# Train the standard Waymo world model on the frozen focus z=1x64 latent.
# Keep the training configuration aligned with the z16 run for a fair ablation.
...
RUN_NAME="${RUN_NAME:-wm_ooi_all_focus_z64_shortcut_seq32_randstart_d512_l8_b8_bf16_gpu1}"
SESSION_NAME="${SESSION_NAME:-wm_focus_z64_gpu1}"
