#!/usr/bin/env bash
# Train the Waymo world model on the frozen focus agent-token latent state.
...
RUN_NAME="${RUN_NAME:-wm_ooi_all_focus_agenttok256_shortcut_seq32_randstart_d512_l8_b8_bf16_gpu2}"
SESSION_NAME="${SESSION_NAME:-wm_focus_agenttok_gpu2}"
