#!/usr/bin/env bash
# Fine-tune H90 with one shortcut sample per predicted frame (D1), initialized
# from the last known-good H30 checkpoint at step 10k.
...
RUN_NAME="waymo_wm_time1_mapx1_h30step10k_exact_ctx1_h90_d1_b1_50k"
...
SESSION_NAME="${SESSION_NAME:-wm_time1_mapx1_h30step10k_h90_d1_cuda0}"
...
{
  echo "===== $(date) H90 D1 training start ====="
...
echo "===== $(date) H90 D1 training complete =====" | tee -a "$PIPELINE_LOG"
