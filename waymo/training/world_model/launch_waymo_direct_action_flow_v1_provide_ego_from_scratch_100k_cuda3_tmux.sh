...
# The recorded ego action sequence is provided; all valid non-ego agents are
# generated and supervised. All other settings match the generate-all run.
...
RUN_NAME="${RUN_NAME:-waymo_direct_action_flow_v1_h15_b5_provideego_scratch100k_phys5_yaw075_huber_bounded_tmax090_lr5e5}"
SESSION_NAME="${SESSION_NAME:-wm_daf_h15_provideego_scratch100k_cuda${CUDA_DEVICE}}"
...
# This is a fresh matched-control run. Refuse accidental resume or overwrite.
...
if [[ "${RUN_INSIDE_TMUX:-0}" != "1" ]]; then
  ...
  echo "Started fresh ego-conditioned training in tmux: $SESSION_NAME"
...

{
  ...
  echo "focus=recorded_future_action generated=nonfocus_agents supervised=valid_nonfocus_agents"
  echo "matched_generateall_run=waymo_direct_action_flow_v1_h15_b5_generateall_scratch100k_phys5_yaw075_huber_bounded_tmax090_lr5e5"
