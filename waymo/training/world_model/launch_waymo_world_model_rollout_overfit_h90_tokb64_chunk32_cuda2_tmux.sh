#!/usr/bin/env bash
# H90 rollout overfit with the b64 tokenizer and overlapping 32-step tokenizer chunks.
...
INIT_CKPT="${INIT_CKPT:-$REPO_ROOT/waymo/checkpoints/waymo_wm_v1_egoact_focus_raw_noclamp_win11_ctx1_h10_randstart_b2_norecon_time1_besttok_1m/step_01000000.pt}"
TRAIN_DATA="${TRAIN_DATA:-$REPO_ROOT/waymo/data/world_model_overfit_subsets/wm_overfit_scenes8_randwin_self05_ctx1_h10_20260720/train}"

RUN_NAME="${RUN_NAME:-wm_rollout_overfit_train8_fixed_ctx1_h90_tokb64_chunk32s30_d025_initbesttok1m_20260723}"
...

{
  ...
  echo "objective=rollout fixed_start=1 ctx=1 horizon=90 seq_len=91"
  echo "tokenizer_chunk_window=32 tokenizer_chunk_stride=30 ranges_for_T91=0:32,30:62,59:91 keep_earlier_overlap=1"
