#!/usr/bin/env bash
# Direct H90 fine-tuning from the selected Stage-1 shortcut checkpoint,
# intentionally skipping the H30 stage. Tokenizer I/O uses overlapping
# 32-frame windows with stride 30.
...
INIT_CKPT="$REPO_ROOT/waymo/checkpoints/waymo_wm_original_stmlayer_3_stage/waymo_wm_v1_egoact_focus_raw_noclamp_win11_randstart_b8_self05_norecon_time1_mapx1_1m/best.pt"

RUN_NAME="waymo_wm_original_stmlayer_stage1best_direct_h90_d1_chunk32s30_b1_50k"
...
SESSION_NAME="${SESSION_NAME:-wm_original_stmlayer_stage1best_direct_h90_chunk32s30_cuda0}"
...
{
  echo "===== $(date) Stage1-best direct H90 D1 chunk32s30 training start ====="
...
echo "===== $(date) Stage1-best direct H90 D1 chunk32s30 training complete =====" | tee -a "$PIPELINE_LOG"
